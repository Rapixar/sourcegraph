...
import { usePoliciesConfig, useDeletePolicies } from './usePoliciesConfigurations'
...
export const RepositoryPolicies: FunctionComponent<RepositoryPoliciesProps> = ({
    ...
    const handleDelete = useCallback(
        async (id: string, name: string) => {
            ...
            return handleDeleteConfig({ variables: { id } })
        },
    ...
    return (
        <Container>
            ...
            {loadingPolicies ? (
                ...
                <PoliciesList
                    policies={policies}
                    onDeletePolicy={repo.id === null ? handleDelete : undefined}
